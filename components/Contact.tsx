              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="text-gray-300 text-sm space-y-1">
                    <li className="flex justify-between w-full max-w-[240px]"><span>Mon - Sat:</span> <span>8:00am to 9:00pm</span></li>
                    <li className="flex justify-between w-full max-w-[240px]"><span>Sundays:</span> <span>2:00pm to 8:00pm</span></li>
                  </ul>
                </div>
              </div>
